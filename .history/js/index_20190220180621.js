        ...
        if (partChecked) {
            ...
            if (register) {
                switch (partNum) {
                    case 0:
                        $('.part').text('龙头');
                        $('#dragon').children('li:nth-child(1)').show();
                        break;
                    case 1:
                        $('.part').text('龙角');
                        $('#dragon').children('li:nth-child(2)').show();
                        break;
                    case 2:
                        $('.part').text('龙身');
                        $('#dragon').children('li:nth-child(3)').show();
                        break;
                    case 3:
                        $('.part').text('龙爪');
                        $('#dragon').children('li:nth-child(4)').show();
                        break;
                    case 4:
                        $('.part').text('龙尾');
                        $('#dragon').children('li:nth-child(5)').show();
                        break;
                }
                $('.tc-3').show();
            } else {
